...
float newX(float x1, float y1, float r1,float x2, float y2, float r2,float x3, float y3, float r3) {
...
float newY(float x1, float y1, float r1,float x2, float y2, float r2,float x3, float y3, float r3) {
	//(-2* x1 + 2 * x2) * x + (-2 * y1 + 2 * y2) * y = (r1)^2 - (r2)^2 - (x1)^2 + (x2)^2 - (y1)^2 + (y2)^2
	//(-2* x2 + 2 * x3) * x + (-2 * y2 + 2 * y3) * y = (r2)^2 - (r3)^2 - (x2)^2 + (x3)^2 - (y2)^2 + (y3)^2
	float a = (-2* x1 + 2 * x2);
	float b = (-2 * y1 + 2 * y2);
